<?php require_once 'inc/header.php'; ?>
    <title>Accomodazione - Villa Sol</title>
        ...
        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 1400px; height: 692px; overflow: hidden;">
            <div>
                ...
                top: 645px; left: 200px; width: 1000px; height: 45px;">
                    Appartamento dalla terrazza esterna con vista sul mare.
                </div>
            ...
            <div>
                ...
                <div u="caption" t="caption-transition-name" class="jssor_text visible-lg" style="position: absolute;
                top: 645px; left: 200px; width: 1000px; height: 45px;">
                    Il lato strada della casa con spazio per il parcheggio.
                </div>
                <div u="caption" t="caption-transition-name" class="jssor_text visible-sm visible-md" style="position: absolute;
                top: 625px; left: 200px; width: 1000px; height: 65px;">
                    Il lato strada della casa con spazio per il parcheggio.
            ...
            <div>
                ...
                <div u="caption" t="caption-transition-name" class="jssor_text visible-lg" style="position: absolute;
                top: 645px; left: 200px; width: 1000px; height: 45px;">
                    Pianterreno. Soggiorno. Divano letto.
                </div>
                <div u="caption" t="caption-transition-name" class="jssor_text visible-sm visible-md" style="position: absolute;
                top: 625px; left: 200px; width: 1000px; height: 65px;">
                    Pianterreno. Soggiorno. Divano letto.
            ...
            <div>
                ...
                <div u="caption" t="caption-transition-name" class="jssor_text visible-lg" style="position: absolute;
                top: 645px; left: 200px; width: 1000px; height: 45px;">
                    Primo piano, camera matrimoniale con aria condizionata, uscita sulla terrazza.
                </div>
                <div u="caption" t="caption-transition-name" class="jssor_text visible-sm visible-md" style="position: absolute;
            ...
            <div>
                ...
                <div u="caption" t="caption-transition-name" class="jssor_text visible-lg" style="position: absolute;
                top: 645px; left: 200px; width: 1000px; height: 45px;">
                    Primo piano, camera doppia con aria condizionata, uscita sulla terrazza.
                </div>
                <div u="caption" t="caption-transition-name" class="jssor_text visible-sm visible-md" style="position: absolute;
                top: 625px; left: 100px; width: 1200px; height: 65px;">
                    Primo piano, camera doppia con aria condizionata, uscita sulla terrazza.
...
<!--            <div>
    ...
    <h4 class="accomodation_header">ACCOMODAZIONE</h4>
    <div class="col-lg-6 line"></div>
    
    <div class="col-lg-4 col-lg-push-4 center-block accomodation_text">
        
        <p>
            <p>L’appartamento per 4 - 6 persone</p>
            <p>Il cortile: 555m2 </p>
            <p>La casa: 181 m2, nuova, isolamento termico</p>
            <p>Pianterreno:</p>
            <ul>
                <li>Soggiorno con cucina (LCD TV, TV via cavo, internet, Wi-Fi, stereo, piano cottura e forno, cappa cucina, forno a microonde, macchina da caffè, frigorifero con congelatore, lavastoviglie, divano letto)</li>
                <li>Bagno con wc (cabina doccia, lavatrice, asciugacapelli)</li>
                <li>Terrazza grande (35 m2) con mobili da giardino, vista sul mare</li>
                <li>Ripostiglio (asse da stiro, ferro da stiro, stendino asciugabiancheria)</li>
            </ul>

            <p>Primo piano:</p>
            <ul>
                <li>Due stanze da letto – matrimoniale e doppia (aria condizionata, terrazze con la vista sul mare – 2,5 m2 e 11 m2)</li>
                <li>Bagno con wc (cabina doccia, asciugacapelli)</li>
            </ul>
