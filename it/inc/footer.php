    ...
    <div class="container">
        <div class="row" style="width: 100%;">
            <div class="col-lg-6 main_contact">
                    ...
                    <div><p class="makija">Indirizzo: </p><p style="color: black;"> Kanica 160c, Rogoznica, Croatia</p><br></div>
...
</a><div id="awcc1412266450053" class="aw-widget-current"  data-locationkey="121785" data-unit="c" data-language="it" data-useip="false" data-uid="awcc1412266450053"></div><script type="text/javascript" src="http://oap.accuweather.com/launch.js"></script>
            ...
            <br/>
            <br/>
            <div class="col-lg-12 signature">Tutti i diritti riservati. Sviluppato da <span class="glyphicon glyphicon-copyright-mark"></span><a href="https://www.linkedin.com/in/frafajec" target="_blank">Filip Rafajec</a></div>
        </div>
    </div>
</footer>
</div> <!-- all -->
