...
<footer id="footer">
    <div class="container">
        <div class="row" style="width: 100%;">
            ...
            <br/>
            <br/>
            <div class="col-lg-12 signature">Tutti i diritti riservati. Sviluppato da <span class="glyphicon glyphicon-copyright-mark"></span><a href="http://www.siginum.com/" target="_blank">Siginum</a></div>
        </div>
    </div>
</footer>
</div> <!-- all -->
