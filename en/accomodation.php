<?php require_once 'inc/header.php'; ?>
    ...
    <div id="slider1_container" style="position: relative; top: 0px; left: 0px; width: 800px;
        height: 456px; background: #191919; overflow: hidden; margin-left: auto; margin-right: auto;">
        ...
        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 800px; height: 356px; overflow: hidden;">
            <div>
                ...
                top: 331px; left: 100px; width: 600px; height: 25px;">
                    Do you see that?
                </div>
            </div>
            <div>
        ...
        <div u="thumbnavigator" class="jssort01" style="position: absolute; width: 800px; height: 100px; left:0px; bottom: 0px;">
            ...
            <div u="slides" style="cursor: move;">
                <div u="prototype" class="p" style="position: absolute; width: 94px; height: 72px; top: 0; left: 0;">
